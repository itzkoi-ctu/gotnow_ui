    ...
    const handlePaymentAndOrder = async (event) => {
        ...
        try {
            ...
            if (paymentIntent.status === "succeeded") {
                await dispatch(placeOrder({ userId: userId, address: billingAddress })).unwrap();
                ...
                <Row>
                    <Col md={8}>
                        <Form className="p-4 border rounded shadow-sm bg-light">
                            ...
                            <div>
                                <h6 className="mt-3 mb-2">Enter Billing Address</h6>
                                <AddressForm
                            ...
                            <div className="form-group mt-3">
                                ...
                                <div id="card-element" className="form-control shadow-sm">
                                    <CardElement
                                        onChange={(event) => {
                    ...
                    <Col md={4}>
                        ...
                        <Card style={{ backgroundColor: "whiteSmoke" }}>
                            ...
                            <button
                                type="submit"
                                className="btn btn-warning mt-3 w-100 shadow-sm"
                                disabled={!stripe}
